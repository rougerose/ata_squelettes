  ...
  var SearchBox = /*#__PURE__*/function () {
    ...
    _createClass(SearchBox, [{
      ...
      value: function _initLayout(container) {
        ...
        for (var _index = 0; _index < this._inputs.length; _index++) {
          var input = this._inputs[_index];
          this._inputsIdArray[_index] = input.dataset.id;
        ...
        for (var _index2 = 0; _index2 < this._cancelBtns.length; _index2++) {
          var btn = this._cancelBtns[_index2];
          var id = btn.dataset.relId;
          this._cancelBtnsIdArray[_index2] = id;

          var inputIndex = this._inputsIdArray.indexOf(id);

          if (inputIndex !== -1) {
            var _input = this._inputs[inputIndex];
            btn.addEventListener("click", this._onclickCancelBtn.bind(_input));
          }
        }
      }
    }, {
      ...
      key: "_emitSearchboxEvents",
      value: function _emitSearchboxEvents(element, eventName, target) {
      ...
      value: function _addMarkup(label, value) {
        ...
        */
        ...
        li.appendChild(btn); // Identifier le conteneur
      ...
      value: function addKeyword(keyword) {
        ...
        if (this._keywordsValues.indexOf(value) == -1) {
          ...
          this._emitSearchboxEvents(this._container, "update", this._keywordsValues);
        }
      }
    }, {
      key: "removeKeyword",
